                ...
                <footer class="mt-8">
                    <div class="md:flex md:items-center md:justify-center">
                        <div class="md:flex-shrink-0">
                            <img alt="Taylor" loading="lazy" class="mx-auto h-10 w-10 rounded-full" src="{{ asset('assets/img/taylor.jpg') }}"/>
                        </div>
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            <div class="text-base leading-6 font-medium text-gray-900">
                                Taylor Otwell
                            </div>
                            <svg class="hidden md:block mx-1 h-5 w-5 text-purple-600" fill="currentColor" style="color: #ff89ff" viewbox="0 0 20 20">
        ...
        <div class="relative">
            <blockquote class="mt-4">
                ...
                <footer class="mt-8">
                    <div class="md:flex md:items-center md:justify-center">
                        <div class="md:flex-shrink-0">
                            <img alt="Freek" loading="lazy" class="mx-auto h-10 w-10 rounded-full" src="{{ asset('assets/img/freek.jpg') }}"/>
                        </div>
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            <div class="text-base leading-6 font-medium text-gray-900">
