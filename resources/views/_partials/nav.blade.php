<header class="sticky top-0 z-50 border-b border-zinc-700 bg-zinc-900/85 backdrop-blur-md">
    <nav aria-label="Main" class="h-15.5 container mx-auto flex items-center gap-7 px-5 sm:px-10">
        ...
        <div class="ml-2 hidden gap-6 lg:flex">
            ...
            <a class="text-sm font-medium text-zinc-400 underline-offset-4 transition-colors hover:text-white hover:underline" href="https://youtube.com/@nunomaduro">YouTube</a>
            <a class="text-sm font-medium text-zinc-400 underline-offset-4 transition-colors hover:text-white hover:underline" href="https://github.com/sponsors/nunomaduro">Sponsor</a>
        </div>
